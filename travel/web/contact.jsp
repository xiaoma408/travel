...
<!-- Page Header -->
<header class="masthead" style="background-image: url('img/home/Gird/bg1.jpg')">
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="page-heading">
          <h1>攻略</h1>
          <span class="subheading">come to go</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-8 col-md-10 mx-auto">
      ...
      <c:forEach var="article" items="${articles}">
        <div class="post-preview">
          <a href="http://localhost:1080/travel/article?id=${article.id}">
            <h2 class="post-title">
                ${article.title}
            </h2>
          </a>
